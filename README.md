...
The program makes use of a backtracking algorithm and is capable of computing Hamiltonian paths for inputs up to 20'000 relatively easily. If no path exists, the output is ```None```.
